...
열여섯 방향 시선으로 커서를 좇는다. 잡아서 끌면 끄는 방향으로 달리고, 움직이는 채로 놓으면
포물선을 그리며 날아가 화면 끝에서 튕기고 자리를 잡는다.

**시켜서.** 우클릭하면 메뉴가 나온다. 손 흔들기, 점프, 뽀모도로 시작(25분 집중 5분 휴식),
펫 바꾸기, 돌아다니기 끄기, 마우스를 안 잡도록 클릭 통과로 만들기, 부팅 시 자동 실행.
...
그대로 두고, `--uninstall`로 전부 되돌릴 수 있다. 자세한 건 `claude-overlay/README.md`에 있다.
