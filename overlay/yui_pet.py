...
TR = {
    "en": {
        ...
        "리츠": "Ritsu", "츠무기": "Tsumugi", "아즈사": "Azusa", "다행이": "Dahaengi",
        # 메뉴 · 동작
...
PET_NAMES = {"": "유이 (기본)", "mio": "미오", "ritsu": "리츠",
             "tsumugi": "츠무기", "azusa": "아즈사", "dahaengi": "다행이",
             "chibi-yui": "유이 (치비)"}
# 목록에 세우는 차례 — 밴드 결성 순서대로 두고 마스코트와 옛 디자인을 뒤에 붙인다.
# 여기 없는 폴더는 이름순으로 맨 뒤에 붙는다(새 펫을 넣어도 목록에서 사라지지 않게).
PET_ORDER = ["", "mio", "ritsu", "tsumugi", "azusa", "dahaengi", "chibi-yui"]
